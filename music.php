                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="nav nav-pills nav-justified">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="pill" href="#latest">Wizkiz</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="#popular">Naira Marley</a>
                            </li>
                            <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#featured">Burna Boy</a>
                            </li>
                        </ul>
